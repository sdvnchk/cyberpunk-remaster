...
requireMaintenanceWrite("Восстановление внешних системных иконок");
...
const foundryRoot = requireAuthorPath(
  process.env.FOUNDRY_INSTALLATION_ROOT ??
    (authorPaths.foundryAppRoot
      ? path.resolve(authorPaths.foundryAppRoot, "..")
      : null),
  "Корневая папка установки Foundry",
);
...
const mappings = new Map([
  ...
  ["programs/blue-comet.webp", "systems/sf2e/icons/abilities/blue-comet.webp"],
  ...
  ["programs/dispel-magic.webp", "systems/sf2e/icons/spells/dispel-magic.webp"],
  [
  ...
  ["programs/feeblemind.webp", "systems/sf2e/icons/spells/feeblemind.webp"],
  ["programs/magic-mouth.webp", "systems/sf2e/icons/spells/magic-mouth.webp"],
  [
  ...
  ["weapons/grenade.webp", "systems/sf2e/icons/equipment/weapons/grenade.webp"],
]);
