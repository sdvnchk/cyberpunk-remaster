...
requireMaintenanceWrite("Добавление устаревшего сканирования интерфейсов");
const itemsPath = path.join(root, "content", "exports", "items.json");
const journalsPath = path.join(root, "content", "exports", "journals.json");

const MODULE_ID = "cyberpunk-remaster";
const ACTION_ID = "ChromeProbeAct01";
const ACTION_UUID = `Compendium.${MODULE_ID}.cyberpunk-items.Item.${ACTION_ID}`;
...
const actionItem = {
  ...
  system: {
    ...
    traits: {
      otherTags: [],
      value: ["arcane", "concentrate", "netrunner"],
    },
    actionType: {
      value: "free",
    },
...
const traitRewrites = new Map([
  ...
  ["<strong>[устройство:X]</strong>", "<strong>Конкретный интерфейс</strong>"],
