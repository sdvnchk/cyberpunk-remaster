...
requireMaintenanceWrite("Восстановление имён иконок");
...
const dataRoot = requireAuthorPath(
  authorPaths.foundryDataRoot,
  "Папка данных Foundry",
);
const appRoot = requireAuthorPath(
  authorPaths.foundryAppRoot,
  "Папка приложения Foundry",
);
